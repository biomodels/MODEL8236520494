...
`pip install git+https://github.com/biomodels/MODEL8236520494.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL8236520494.git@20140916`

## Usage

Importing the model package.

`import MODEL8236520494 as model`
...
This is the arachidonic acid metabolic network model for human platelet cells
(PLT) described in the article:  
...
The model is an updated version of the supplementary material of the article (
[Supplementary Information
3](http://www.nature.com/msb/journal/v4/n1/extref/msb200860-s4.xml) ). The
only difference are the parameter names.
